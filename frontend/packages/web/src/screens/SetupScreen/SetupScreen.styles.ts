export const useSetupScreenStyles = () => ({
    container: 'flex h-dvh w-full items-center justify-center bg-surface px-4',
    ...
    submitButton: 'w-full rounded-lg bg-primary-800 py-2 text-sm font-medium text-text-inverted ' +
